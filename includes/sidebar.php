<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-qrcode fa-fw"></i> Barang<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="index.php?page=databarang"><i class="fa fa-angle-right fa-fw"></i>Data Barang</a>
                    </li>
                    <li>
                        <a href="index.php?page=barangbaru"><i class="fa fa-angle-right fa-fw"></i>Tambah Barang</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="index.php?page=peminjaman"><i class="fa fa-angle-right fa-fw"></i>Data Invoice</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="supplier.php"><i class="fa fa-angle-right fa-fw"></i>Data Supplier</a>
                    </li>
                    <li>
                        <a href="supplier.php?page=supplierbaru"><i class="fa fa-angle-right fa-fw"></i>Tambah Supplier</a>
                    </li>
                </ul>
            </li>
            <li>
